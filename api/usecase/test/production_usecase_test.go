...
func Test_Consump(t *testing.T) {
	var (
		...
		productionRepo *mock_repository.MockProductionRepository
		productionServ *mock_service.MockProductionService
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			productionUsecase := usecase.NewProductionUsecase(txRepo, productionRepo, productionServ, itemRepo, inventoryRepo, generalRepo)

			preInventory, err := productionUsecase.Consump(tt.arg.production)
			if err != nil {
